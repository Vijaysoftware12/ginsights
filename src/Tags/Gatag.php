<?php
namespace GInsights\Gaddon\Tags;

use Statamic\Tags\Tags;
use Symfony\Component\Yaml\Yaml;

class Gatag extends Tags
{
    /**
     * The {{ gatag }} tag.
     *
    ...
    {
       // return 'Hello, this is your custom tag!';
	//   '<script>alert("hii");</script>';
        ...
        // $filePath = $rootPath . '/addons/analytics/gaddon/src/content/gtag.yaml';
