...
<circle fill-opacity="0.125" fill="#1065a6" r="6" cy="0" cx="0">
  ...
  <animate begin="0s" values="1;0" repeatCount="indefinite" dur="1s" keyTimes="0;1" attributeName="fill-opacity"></animate>
        ...
        <div class="p-4 font-bold content-center">
          ...
          <a href='<?php echo cp_route('utilities.index').'/analytics' ?>?reauth=true' class="btn-primary ml-1 mr-1 mt-2 " title="Connect to Google" id="ConnecttoGoogle">Connect to Google</a>
        </div>
      </div>
