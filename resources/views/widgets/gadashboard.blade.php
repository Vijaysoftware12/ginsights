...
<script src="<?php echo $baseUrl;?>/vendor/gaddon/js/jquery-ui.js"></script> 
<script src="<?php echo $baseUrl;?>/vendor/gaddon/js/Chart.js"></script> 


<link rel="stylesheet" href="<?php echo $baseUrl;?>/vendor/gaddon/css/jquery-ui.css">
<link rel="stylesheet" href="<?php echo $baseUrl;?>/vendor/gaddon/css/all.min.css">
