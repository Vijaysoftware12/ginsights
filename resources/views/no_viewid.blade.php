	...
	<body>   
		<div class="row card ">    
			<div class="p-2 ">
				...
				<a href='<?php echo cp_route('utilities.index').'/analytics' ?>?reauth=true' class="text-center block w-full h-full"><button class="mt-6 bg-blue-700 text-white font-bold py-2 px-4 rounded ">Click here to reauthorize</button></a>			   
			</div> 				
		</div>
	</body>
