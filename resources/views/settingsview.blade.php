...
@section('content')
	...
	<header class="mb-3">
		...
		<script src="<?php echo $baseUrl;?>/vendor/gaddon/js/jquery-3.7.0.slim.js"></script> 
	...
	<body>   
		<div class="row  mt-2 mb-2  ">    
			...
			<div class="card flex flex-col mb-4 ">	
				...
				<?php 
				$rootPath = base_path();				
				$filePath = $rootPath . '/addons/vijaysoftware/ginsights/src/content/webproperty.yaml';				
				...
				//For reading gtag
				$filePath1 = $rootPath . '/addons/vijaysoftware/ginsights/src/content/gtag.yaml';	
