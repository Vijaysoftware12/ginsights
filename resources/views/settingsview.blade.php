...
@section('content')
    ...
    <a class="breadcrumbspan" href="<?php echo cp_route('utilities.index').'/analytics' ?>" > GInsights Analytics</a>
    <span class="breadcrumb">&nbsp;&lt;&nbsp;</span>
	...
	<body>   
		...
		<div class="row  mt-2 mb-2  ">    
			...
			<!--<div class="card flex flex-col ">	
				...
				<a href='<?php echo cp_route('utilities.index').'/analytics' ?>?reauth=true' class="block w-full h-full"><button class="bg-blue-700 text-white font-bold py-2 px-6 rounded w-1/2">Launch Setup Wizard</button></a>
		...
		console.log(storedValue);
			...
			window.location.href = '<?php echo cp_route('utilities.index').'/analytics' ?>?reauth=true';
		}
		</script>
	</body>
@stop