...
@section('content')
	...
	<header class="mb-3">
       ...
       <!-- <div class="gcard_heading">
		...
		?>
        <script type="text/javascript" src="<?php echo $baseUrl;?>vendor/gaddon/js/jquery-3.6.0.min.js"></script>
        
        <script type="text/javascript" src="<?php echo $baseUrl;?>vendor/gaddon/js/all.min.js" crossorigin="anonymous"></script>
        <script type="text/javascript" src="<?php echo $baseUrl;?>vendor/gaddon/js/jquery-ui.js"></script>
        <script type="text/javascript" src="<?php echo $baseUrl;?>vendor/gaddon/js/Chart.js"></script> 
        
        
        <script type="text/javascript" src="<?php echo $baseUrl;?>vendor/gaddon/js/jquery.dataTables.min.js"></script>
        <link rel="stylesheet" href="<?php echo $baseUrl;?>vendor/gaddon/css/jquery.dataTables.min.css">
      <!--  <link rel="stylesheet" href="../../../../resources/css/ga_style.css">-->
        ...
        <link rel="stylesheet" href="<?php echo $baseUrl;?>vendor/gaddon/css/font-awesome.min.css">
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css">
	        
    <!-- Include Date Range Picker library -->
    <link rel="stylesheet" type="text/css" href="<?php echo $baseUrl;?>vendor/gaddon/css/daterangepicker.css" />
    <script type="text/javascript" src="<?php echo $baseUrl;?>vendor/gaddon/js/moment.min.js"></script>
    <script type="text/javascript" src="<?php echo $baseUrl;?>vendor/gaddon/js/daterangepicker.min.js"></script>
  
    <!--new-->

    <link rel="stylesheet" href="<?php echo $baseUrl;?>vendor/gaddon/css/jquery-ui.css">
    <script src="<?php echo $baseUrl;?>vendor/gaddon/js/html2pdf.bundle.min.js" integrity="sha512-GsLlZN/3F2ErC5ifS5QtgpiJtWd43JWSuIgh7mbzZ8zBps+dvLusV+eNQATqgA/HdeKFVgA5v3S/cIrLF7QnIg==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
